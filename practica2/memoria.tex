...
\item \href{https://en.wikipedia.org/wiki/Silhouette_%28clustering%29}
  ...
  % TODO frente a accidentes en condiciones adversas
  y los accidentes que ocurren a altas horas de la madrugada.
  % TODO frente a los que ocurren por la tarde a horas ``comunes'' para la conducción.
  ...
  \section{Caso de estudio 1: Análisis de los accidentes en
    condiciones óptimas para la conducción}%TODO frente a los ocurridos en condiciones adversas}

  % TODOPara la primera clase que compararemos en este primer caso de estudio
